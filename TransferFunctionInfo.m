...
% Introduction
fprintf('This program provides valuable information about your system by using\n')
fprintf('the coefficients of you system Transfer Function and inputing them as\n')
fprintf('vector. The numerators and denominators have to be distributed\n')
fprintf('i.e. s^2 + 11s + 30, rather than (s+5)(s+6)\n')
fprintf('Which in vector form is [1 11 30]\n\n')
